...
-- Add fiscal_year_end, aga_planned_date, aga_completed_date, and aga_status to clients table

ALTER TABLE public.clients ADD COLUMN IF NOT EXISTS fiscal_year_end DATE;
