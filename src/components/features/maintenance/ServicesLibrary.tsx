        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="flex flex-1 gap-3 w-full md:w-auto">
                    <div className="relative flex-1 max-w-sm">
                        ...
                        <Input
                            ...
                            className="bg-[#16171e]/70 border-zinc-850 h-9 text-xxs pl-9 text-white focus-visible:ring-purple-650 focus-visible:border-purple-650"
                        />
                    </div>
                    <select
                        value={selectedCategory}
                        onChange={(e) => setSelectedCategory(e.target.value)}
                        className="bg-[#16171e]/70 border border-zinc-850 rounded-xl px-3 text-xxs text-white h-9 outline-none cursor-pointer"
                    >
                ...
                {!showForm && (
                    <Button
                        ...
                        className="bg-purple-650 hover:bg-purple-700 text-white font-bold text-xxs h-9 px-4 rounded-xl shadow cursor-pointer w-full md:w-auto flex items-center gap-1.5"
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 text-xxs">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <Label className="text-zinc-500 uppercase font-bold text-[8px]">Nom du service *</Label>
                                    <Input
                                        value={name}
                                ...
                                <div className="space-y-1.5">
                                    <Label className="text-zinc-500 uppercase font-bold text-[8px]">Catégorie</Label>
                                    <select
                                        value={category}
                            ...
                            <div className="space-y-1.5">
                                <Label className="text-zinc-500 uppercase font-bold text-[8px]">Description</Label>
                                <Textarea
                                    value={description}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div className="space-y-1.5">
                                    <Label className="text-zinc-500 uppercase font-bold text-[8px]">Durée moyenne (minutes) *</Label>
                                    <Input
                                        type="number"
                                        value={duration}
                                ...
                                <div className="space-y-1.5">
                                    <Label className="text-zinc-500 uppercase font-bold text-[8px]">Tarif estimé ($)</Label>
                                    <Input
                                        type="number"
                                        step="0.01"
                                        value={price}
                                ...
                                <div className="space-y-1.5">
                                    <Label className="text-zinc-500 uppercase font-bold text-[8px]">Contracteur par défaut</Label>
                                    <select
                            ...
                            <div className="flex gap-6 items-center p-3 bg-zinc-900/30 border border-zinc-850 rounded-xl">
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="h-4 w-4 rounded border-zinc-800 bg-[#121318] text-purple-600 focus:ring-purple-650 cursor-pointer"
                                    />
                                    <Label htmlFor="photosRequired" className="text-zinc-300 font-semibold cursor-pointer flex items-center gap-1.5">
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="h-4 w-4 rounded border-zinc-800 bg-[#121318] text-purple-600 focus:ring-purple-650 cursor-pointer"
                                    />
                                    <Label htmlFor="reportRequired" className="text-zinc-300 font-semibold cursor-pointer flex items-center gap-1.5">
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                ...
                                >
                                    {saving ? 'Enregistrement...' : <><Check className="h-3.5 w-3.5" /> Enregistrer</>}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredServices.length === 0 ? (
                    <div className="col-span-full text-center py-12 text-xxs text-zinc-500 bg-zinc-950/20 border border-zinc-900 rounded-xl">
                        Aucun service ne correspond aux critères de recherche.
                    </div>
                ) : (
                    filteredServices.map(svc => (
                        <Card key={svc.id} className="bg-[#16171e]/70 border-zinc-850 hover:border-zinc-800 transition-all text-xxs">
                            <CardHeader className="pb-2 flex flex-row justify-between items-start gap-4">
                                <div className="space-y-1">
                                    <Badge variant="outline" className="text-[7px] font-extrabold uppercase px-1.5 py-0 bg-purple-950/20 text-purple-300 border-purple-800/40">
                                        {svc.category}
                                    </Badge>
                                    <CardTitle className="text-[11px] font-extrabold text-zinc-100 mt-1 block">
                                        {svc.name}
                                    </CardTitle>
                                </div>
                                <div className="flex gap-1">
                                    <Button
                                        ...
                                        className="h-6 w-6 text-zinc-500 hover:text-purple-400 hover:bg-purple-500/10 rounded-lg cursor-pointer"
                                    >
                                    ...
                                    <Button
                                        ...
                                        className="h-6 w-6 text-zinc-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg cursor-pointer"
                                    >
                            ...
                            <CardContent className="space-y-3 pt-2">
                                {svc.description && (
                                    <p className="text-zinc-400 font-medium leading-relaxed italic text-[10px]">
                                        {svc.description}
                                    </p>
                                )}
                                
                                <div className="grid grid-cols-2 gap-2 text-[10px] font-medium border-t border-zinc-900 pt-2.5">
                                ...
                                <div className="flex items-center gap-3 pt-1">
                                    {svc.photos_required && (
                                        <Badge variant="outline" className="text-[7px] font-bold uppercase bg-zinc-950/40 text-cyan-400 border-cyan-950/40 flex items-center gap-1">
                                            <Camera className="h-2.5 w-2.5" /> Photos
                                        </Badge>
                                    )}
                                    {svc.report_required && (
                                        <Badge variant="outline" className="text-[7px] font-bold uppercase bg-zinc-950/40 text-amber-400 border-amber-950/40 flex items-center gap-1">
                                            <FileText className="h-2.5 w-2.5" /> Rapport
                                        </Badge>
                                    )}
                                </div>
                            </CardContent>
