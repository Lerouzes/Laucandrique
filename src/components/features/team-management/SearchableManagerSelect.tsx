            ...
            <div className="relative flex items-center">
                ...
                {selectedId && (
                    <button
                        ...
                        className="absolute right-7 p-0.5 text-zinc-550 hover:text-white rounded-full hover:bg-zinc-800 transition-colors"
                    >
                        <X className="h-3 w-3" />
                    </button>
                )}
            ...
            {isOpen && (
                <div className="absolute z-[100] mt-1 w-full rounded-lg border border-zinc-800 bg-[#121318] shadow-2xl p-1 animate-in fade-in duration-100 max-h-56 overflow-y-auto divide-y divide-zinc-900/50">
                    {!required && (
                        ...
                        >
                            <span className="truncate italic">-- Aucun gestionnaire --</span>
