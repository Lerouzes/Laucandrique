...
const statusMap: Record<string, { label: string, styles: string }> = {
    draft: { label: 'Brouillon', styles: 'bg-zinc-800 text-zinc-300' },
            ...
            <Table>
                <TableHeader className="bg-zinc-900 border-b border-zinc-800">
                    <TableRow className="border-b border-zinc-800 hover:bg-zinc-900">
                        ...
                        <TableHead className="text-zinc-400 font-medium">Montant Total</TableHead>
                        <TableHead className="text-zinc-400 font-medium">Créée le</TableHead>
