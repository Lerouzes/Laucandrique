...
export function PlanningCalendar({ initialProjects, query = "" }: { initialProjects: any[], query?: string }) {
    ...
    return (
        <div className="flex gap-6 h-full">
            {/* Sidebar */}
            <Card className="w-80 h-full border-zinc-800 bg-zinc-900 flex flex-col shrink-0">
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between gap-2">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <Badge
                                                    variant="secondary"
                                                    className={`pointer-events-none text-xs ${isUnplanned ? 'bg-zinc-800 text-zinc-400' : 'bg-yellow-900/60 text-yellow-300'}`}
                                                >
            ...
            {/* Calendar */}
            <Card className="flex-1 h-full border-zinc-800 bg-zinc-900 p-4 relative overflow-hidden">
